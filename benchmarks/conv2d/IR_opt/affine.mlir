  ...
  func.func @conv2d(%arg0: memref<12x12xi32>, %arg1: memref<3x3xi32>, %arg2: memref<10x10xi32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 10 {
      affine.for %arg4 = 0 to 10 {
        affine.store %c0_i32, %arg2[%arg3, %arg4] : memref<10x10xi32>
        affine.for %arg5 = 0 to 3 {
          affine.for %arg6 = 0 to 3 {
            %0 = affine.load %arg0[%arg3 + %arg5, %arg4 + %arg6] : memref<12x12xi32>
            %1 = affine.load %arg1[%arg5, %arg6] : memref<3x3xi32>
            %2 = arith.muli %0, %1 : i32
            %3 = affine.load %arg2[%arg3, %arg4] : memref<10x10xi32>
            %4 = arith.addi %3, %2 : i32
            affine.store %4, %arg2[%arg3, %arg4] : memref<10x10xi32>
          }
